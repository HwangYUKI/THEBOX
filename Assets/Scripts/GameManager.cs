...
public class GameManager : MonoBehaviour
{
    ...
    private bool doesHaveHammer;            //トンカチをもっているか？
    ...
    void Start()
    {
        wallNo = WALL_FRONT;            //スタート地点では前を向く
        doesHaveHammer = false;         //ハンマーを持っていない
    ...
    //金庫のボタンの色を変更
    void CangeButtonColor (int buttonNo) {
